var dreamfishState = {
    ...
    create: function()
    {
        ...
        var platform = this.platforms.create(300, 75, 'platform');
        platform.body.immovable = true;
        platform = this.platforms.create(10, 150, 'platform');
        platform.body.immovable = true;
        platform = this.platforms.create(500, 225, 'platform');
        platform.body.immovable = true;
        platform = this.platforms.create(200, 300, 'platform');
        platform.body.immovable = true;
        platform = this.platforms.create(400, 375, 'platform');
        platform.body.immovable = true;
        platform = this.platforms.create(100, 450, 'platform');
        platform.body.immovable = true;
        platform = this.platforms.create(600, 450, 'platform');
        platform.body.immovable = true;
        this.portal_gun = game.add.sprite(650, 80, 'portal_gun');
        game.physics.arcade.enable(this.portal_gun);
        this.player = game.add.sprite(game.world.width / 2 - 37, 500, 'fish2');
