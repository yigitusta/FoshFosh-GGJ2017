var collectfish2State = {
    ...
    create: function()
    {
        console.log("State: collectbasket");
        ...
        this.player = game.add.sprite(game.world.width / 2 - 42, game.world.height - 130, 'basket');
        this.basket = game.add.sprite(this.player.x - this.player.width, this.player.y, 'player');
