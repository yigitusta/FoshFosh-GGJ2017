var collectmanState = {
    ...
    create: function()
    {
        ...
        this.player = game.add.sprite(game.world.width / 2 - 100, game.world.height - 85, 'fish1');
        this.basket = game.add.sprite(this.player.x - 80, this.player.y, 'basket');
    ...
    update: function()
    {
        ...
        if (this.basket.x + this.basket.body.width >= this.player.x) {
            this.basket.x--;
            this.player.x++;
        }
    ...
    switch (Math.floor(Math.random() * 8) + 1) {
        case 1:
            fish = this.fishes.create(0, Math.floor(Math.random() * 200), 'player2');
        ...
        case 3:
            ...
            break;
        case 4:
            fish = this.fishes.create(800, Math.floor(Math.random() * 200), 'player2');
            fish.body.velocity.x = (-Math.random() * 150 - 100) * 1.2;
            break;
        case 5:
            fish = this.fishes.create(800, Math.floor(Math.random() * 200), 'player2');
