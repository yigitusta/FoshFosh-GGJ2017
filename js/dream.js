var dreamState = {
    ...
    create: function()
    {
        ...
        var platform = this.platforms.create(350, 320, 'platform');
        platform.body.immovable = true;
        platform = this.platforms.create(30, 240, 'platform');
        platform.body.immovable = true;
        platform = this.platforms.create(140, 430, 'platform');
        platform.body.immovable = true;
        platform = this.platforms.create(650, 150, 'platform');
        platform.body.immovable = true;
        platform = this.platforms.create(300, 125, 'platform');
        platform.body.immovable = true;
        platform = this.platforms.create(75, 350, 'platform');
        platform.body.immovable = true;
        platform = this.platforms.create(600, 350, 'platform');
        platform.body.immovable = true;
        platform = this.platforms.create(500, 500, 'platform');
        platform.body.immovable = true;
        this.portal_gun = game.add.sprite(650, 80, 'portal_gun');
        game.physics.arcade.enable(this.portal_gun);
        this.player = game.add.sprite(game.world.width / 2 - 37, 500, 'player2');
    ...
    update: function()
    {
        ...
        var onTheGround = this.player.body.touching.down || this.player.y >= 528;
    ...
    createFish: function() {
        ...
        switch (Math.floor(Math.random() * 15) + 1) {
            case 1:
                fish = this.fishes.create(0, Math.floor(Math.random() * 500), 'fish1');
                fish.scale.setTo(0.5 , 0.5);
                fish.body.velocity.x = (Math.random() * 150 + 100) * 1.2;
                break;
            case 2:
                fish = this.fishes.create(0, Math.floor(Math.random() * 500), 'fish2');
                fish.scale.setTo(0.5 , 0.5);
                fish.body.velocity.x = (Math.random() * 150 + 100) * 1.2;
                break;
            case 3:
                fish = this.fishes.create(0, Math.floor(Math.random() * 500), 'fish3');
                fish.scale.setTo(0.5 , 0.5);
                fish.body.velocity.x = (Math.random() * 150 + 100) * 1.2;
                break;
            case 4:
                fish = this.fishes.create(800, Math.floor(Math.random() * 500), 'fish1');
                fish.scale.setTo(0.5 , 0.5);
                fish.body.velocity.x = (-Math.random() * 150 - 100) * 1.2;
                break;
            case 5:
                fish = this.fishes.create(800, Math.floor(Math.random() * 500), 'fish2');
                fish.scale.setTo(0.5 , 0.5);
                fish.body.velocity.x = (-Math.random() * 150 - 100) * 1.2;
                break;
            case 6:
                fish = this.fishes.create(800, Math.floor(Math.random() * 500), 'fish3');
                fish.scale.setTo(0.5 , 0.5);
                fish.body.velocity.x = (-Math.random() * 150 - 100) * 1.2;
                break;
            case 7:
                fish = this.fishes.create(800, Math.floor(Math.random() * 500), 'fish4');
                fish.scale.setTo(0.5 , 0.5);
                fish.body.velocity.x = (-Math.random() * 150 - 100) * 1.2;
                break;
            default:
                fish = this.fishes.create(0, Math.floor(Math.random() * 500), 'fish4');
                fish.scale.setTo(0.5 , 0.5);
                fish.body.velocity.x = (Math.random() * 150 + 100) * 1.2;
            }
